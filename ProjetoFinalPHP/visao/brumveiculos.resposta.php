  ...
  <body>
    <header>
      ...
      <div class="p-3 mb-2 bg-light text-dark" style="height: 100%;">
  			<h1 class="display-4" style="font-size: 20px; text-align: justify;; color: #000000;">
          <?php
          if(isset($_SESSION['msg']) &&
             isset($_SESSION['confirma']))
             {
               include "../modelo/brumveiculos.class.php";

               $bv = new BrumVeiculos();
               $bv = unserialize($_SESSION['confirma']);

               echo "</p>".$_SESSION['msg']."</p>".$bv;
             }
             ?>
           </h1>
         </div>
